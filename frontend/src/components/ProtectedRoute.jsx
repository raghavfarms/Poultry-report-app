...
export default function ProtectedRoute({ admin = false, developer = false, attendanceStaff = false, attendanceAdmin = false, children }) {
  ...
  if (attendanceAdmin && !["admin", "developer", "office", "supervisor", "farm_incharge"].includes(user.role)) {
    return <Navigate to="/" replace />;
  }
  return children;
}
