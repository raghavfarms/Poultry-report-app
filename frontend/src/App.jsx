...
export default function App() {
  return <Routes>
    <Route path="/login" element={<LoginPage />} /><Route path="/register" element={<RegisterPage />} /><Route path="/setup" element={<SetupPage />} />
    <Route element={<ProtectedRoute><Layout /></ProtectedRoute>}>
      <Route index element={<OverviewPage />} />
      <Route path="reports/diesel" element={<DieselPage />} />
      <Route path="reports/:slug" element={<ComingSoonPage />} />
      <Route path="admin/assets" element={<ProtectedRoute admin><AssetAdminPage /></ProtectedRoute>} />
    </Route>
